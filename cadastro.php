...
use cadastroUsuario\Usuario;


require 'autoload.php';

$usuario = new App\cadastroUsuario\Usuario($_POST['nome'], $_POST['senha'], $_POST['genero']);
$contato = new App\cadastroUsuario\Contato($_POST['email'], $_POST['endereco'], $_POST['cep'], $_POST['telefone']);
?>
